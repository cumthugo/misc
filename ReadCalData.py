...
class CheckInputFileTestCase(unittest.TestCase):
    ...
    def testCorrectFile(self):
        self.failUnless(check_file(r'E:\private\python\Tools\1.log'),'Correct file but check failed!')
    
    def testFileNotExist(self):
        self.failIf(check_file(r'E:\private\python\Tools\not_exist.log'),'File Not exist should return false!')   
    
    def testEmptyFile(self):
        self.failIf(check_file(r'E:\private\python\Tools\empty.log'),'Empty file should return false')

    def testCtrlError(self):
        self.failIf(check_file(r'E:\private\python\Tools\ctrl_error.log'),'Ctrl field error should return false')
    
    def testByteError(self):
        self.failIf(check_file(r'E:\private\python\Tools\byte_error.log'),'Byte field error should return false')

    def testReadCalError(self):
        self.failIf(check_file(r'E:\private\python\Tools\read_cal_error.log'),'Read Cal field error should return false')
    
    def testReadCalDataError(self):
        self.failIf(check_file(r'E:\private\python\Tools\read_cal_data_error.log'),'Read Cal field error should return false')

    def testWriteCalError(self):
        self.failIf(check_file(r'E:\private\python\Tools\write_cal_error.log'),'Write Cal field error should return false')
    
    def testWriteCalDataError(self):
        self.failIf(check_file(r'E:\private\python\Tools\write_cal_data_error.log'),'Write Cal field error should return false')
